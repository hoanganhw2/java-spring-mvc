                            ...
                            <div class="row text-center justify-content-around">
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-primary text-white mb-4">
                                        ...
                                        <span class="card-text text-center fs-1 ">${countUser}</span>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-warning text-white mb-4">
                                        ...
                                        <span class="card-text text-center fs-1 ">${countProduct}</span>
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="small text-white stretched-link" href="/admin/product">Chi
                                                tiết</a>
                                            <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-success text-white mb-4">
                                        ...
                                        <span class="card-text text-center fs-1 ">${countOrder}</span>
                                        <div class="card-footer d-flex align-items-center justify-content-between">
