                                                ...
                                                <td>
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${order.status == 'CHỜ XÁC NHẬN'}">
                                                            <span
                                                                class="bg-dark text-white text-center d-block rounded-5">${order.status}
                                                            </span>
                                                        </c:when>
                                                    </c:choose>
                                                    </form>
                            ...
                            <ul class="pagination justify-content-center d-flex">
                                <li class="page-item">
                                    <a class="${ 1 eq currentPage ? 'disabled page-link' : 'page-link' }"
                                        href="/view/orders?page= ${ currentPage - 1 }" aria-label="Previous">
                                ...
                                <c:forEach begin="0" end="${totalPage}" varStatus="loop">
                                    <li class="page-item $"><a
                                            ...
                                            href="/view/orders?page=${loop.index+1}">${loop.index +
                                            1}</a>
                                    </li>
                                </c:forEach>
                                <li class="page-item">
                                    <a class="${ (totalPage + 1) eq currentPage ? 'disabled page-link' : 'page-link' } "
                                        href="/view/orders?page= ${ currentPage + 1 }" aria-label="Next">
